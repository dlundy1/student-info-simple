...
Namespace ContactsDataSetTableAdapters
    ...
    Partial Public Class PublishersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Publishers] WHERE (([PubID] = @Original_PubID) AND ((@IsNull_Name = "& _ 
                "1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Company_Name ="& _ 
                " 1 AND [Company Name] IS NULL) OR ([Company Name] = @Original_Company_Name)) AND"& _ 
                ...
                "sNull_Zip = 1 AND [Zip] IS NULL) OR ([Zip] = @Original_Zip)) AND ((@IsNull_Telep"& _ 
                "hone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)) AND (("& _ 
                "@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @Original_Fax)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Publishers] ([PubID], [Name], [Company Name], [Address], [City], [St"& _ 
                "ate], [Zip], [Telephone], [Fax]) VALUES (@PubID, @Name, @Company_Name, @Address,"& _ 
                " @City, @State, @Zip, @Telephone, @Fax);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT PubID, Name, [Company Name], Ad"& _ 
                "dress, City, State, Zip, Telephone, Fax FROM Publishers WHERE (PubID = @PubID) O"& _ 
                "RDER BY Name"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Publishers] SET [PubID] = @PubID, [Name] = @Name, [Company Name] = @Compa"& _ 
                "ny_Name, [Address] = @Address, [City] = @City, [State] = @State, [Zip] = @Zip, ["& _ 
                "Telephone] = @Telephone, [Fax] = @Fax WHERE (([PubID] = @Original_PubID) AND ((@"& _ 
                "IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_"& _ 
                "Company_Name = 1 AND [Company Name] IS NULL) OR ([Company Name] = @Original_Comp"& _ 
                "any_Name)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Ori"& _ 
                ...
                "(@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Tele"& _ 
                "phone)) AND ((@IsNull_Fax = 1 AND [Fax] IS NULL) OR ([Fax] = @Original_Fax)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "SELECT PubID, Name, [Company Name], Address, City, State, Zip, Telephone, Fax FR"& _ 
                "OM Publishers WHERE (PubID = @PubID) ORDER BY Name"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Sem2_WA.My.MySettings.Default.ContactsConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        PubID, Name, [Company Name], Address, City, State, Zip, Telephone, "& _ 
                "Fax"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Publishers"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY Name"
